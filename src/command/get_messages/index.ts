...
import { MessageFilter, MessageFilterConstructor } from "./filters/message_filter";
...
export class GetMessagesCommandHandler extends BaseCommandHandler {
  ...
  protected createMessagesResponse(messages: ({ fromUser: user } & sent_messages)[]): Promise<Response> {
