...
const sendgridWrapper_1 = require("../utils/mail/sendgridWrapper");
class AuthenticateCommandHandler extends base_1.BaseCommandHandler {
    constructor() {
        super(...arguments);
    ...
    sendToken(email) {
        const sgMail = sendgridWrapper_1.MailServiceWrapper.getInstance();
...
AuthenticateCommandHandler.command = "/auth";
